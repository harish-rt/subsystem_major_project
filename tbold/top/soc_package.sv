...
//IPS_CORE
    ...
    `include "../ips_core/axi_intc/lite_intc_sequence.sv"
    `include "../ips_core/axi_intc/lite_intc_driver.sv"
    `include "../ips_core/axi_intc/lite_intc_sequencer.sv"
    `include "../ips_core/axi_intc/lite_intc_monitor.sv"
    `include "../ips_core/axi_intc/lite_intc_agent.sv"

    `include "../ips_core/axi_intc/intr_in_agent.sv"
    `include "../ips_core/axi_intc/irq_out_agent.sv"
