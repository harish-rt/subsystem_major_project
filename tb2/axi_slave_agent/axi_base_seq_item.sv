...
class axi_base_seq_item extends uvm_sequence_item;
  ...
  string str ; /// just for testing wrapper
   ...
   //write data channel
          ...
          logic  [STROBE_WIDTH-1:0] wstrobe;
          logic                     wlast;
          logic                     wvalid;
          logic                     wready;
   ...
   `uvm_object_utils_begin(axi_base_seq_item)
  ...
  /*extern function bit read_pkt_compare(axi_base_seq_item obj1, obj2);
  extern function bit write_pkt_compare(axi_base_seq_item obj1, obj2);
...
/*function bit axi_base_seq_item :: read_pkt_compare (axi_base_seq_item obj1, obj2); // compare read address channel
   bit result =1;
...
function bit axi_base_seq_item :: write_pkt_compare (axi_base_seq_item obj1, obj2); // compare read address channel
   bit result =1;
   if (obj1.operation != obj2.operation)begin
