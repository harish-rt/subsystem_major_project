...
/*                                                                        */
/* AXI_INTERCONNECT_DESIGN/AXI_TB/axi_cdma_axi_master_seq_item.sv                      */
/*                                                                        */
/* RAITON CONFIDENTIAL                                                    */
/*                                                                        */
...
class axi_cdma_axi_master_seq_item extends axi_cdma_axi_base_seq_item;
  //FACTORY REGISTRATION
 `uvm_object_utils(axi_cdma_axi_master_seq_item)
  //MEMEBERS
  //delays
  ...
  function new (string name = "axi_cdma_axi_master_seq_item");
     super.new (name);
  endfunction
...
endclass : axi_cdma_axi_master_seq_item
