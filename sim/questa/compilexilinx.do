...
# Base Paths
# ==============================================================================
set PROJECT_SRC   "D:/VLSI/7 Protocol/RISCV/SS/core_ip_wraps/rtl/core_ip_wraps.srcs/sources_1/bd/core_ip_wraps"
set XILINX_VIVADO "D:/opt/xilinx/2025.1/Vivado"
set INCDIR        "+incdir+$PROJECT_SRC/ipshared/ec67/hdl"

# ==============================================================================
# Xilinx Primitive Libraries (UNISIM)
# ==============================================================================
vlib riviera/unisim
vmap unisim riviera/unisim
...
# --- IP Packages & Submodules ---
vlog -work generic_baseblocks_v2_1_0 -vlog01compat $INCDIR \
"$PROJECT_SRC/ipshared/b752/hdl/generic_baseblocks_v2_1_vl_rfs.v"

vlog -work axi_infrastructure_v1_1_0 -vlog01compat $INCDIR \
"$PROJECT_SRC/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v"

vlog -work axi_register_slice_v2_1_20 -vlog01compat $INCDIR \
"$PROJECT_SRC/ipshared/72d4/hdl/axi_register_slice_v2_1_vl_rfs.v"

vlog -work fifo_generator_v13_2_5 -vlog01compat $INCDIR \
"$PROJECT_SRC/ipshared/276e/simulation/fifo_generator_vlog_beh.v"

vcom -work fifo_generator_v13_2_5 -93 \
"$PROJECT_SRC/ipshared/276e/hdl/fifo_generator_v13_2_rfs.vhd"

vlog -work fifo_generator_v13_2_5 -vlog01compat $INCDIR \
"$PROJECT_SRC/ipshared/276e/hdl/fifo_generator_v13_2_rfs.v"

vlog -work axi_data_fifo_v2_1_19 -vlog01compat $INCDIR \
"$PROJECT_SRC/ipshared/60de/hdl/axi_data_fifo_v2_1_vl_rfs.v"

vlog -work axi_crossbar_v2_1_21 -vlog01compat $INCDIR \
"$PROJECT_SRC/ipshared/6b0d/hdl/axi_crossbar_v2_1_vl_rfs.v"

vlog -work core_ip_wraps -vlog01compat $INCDIR \
"$PROJECT_SRC/ip/core_ip_wraps_xbar_0/sim/core_ip_wraps_xbar_0.v"

vcom -work axi_lite_ipif_v3_0_4 -93 \
"$PROJECT_SRC/ipshared/66ea/hdl/axi_lite_ipif_v3_0_vh_rfs.vhd"

vcom -work axi_intc_v4_1_14 -93 \
"$PROJECT_SRC/ipshared/f78a/hdl/axi_intc_v4_1_vh_rfs.vhd"

vcom -work core_ip_wraps -93 \
"$PROJECT_SRC/ip/core_ip_wraps_axi_intc_0_0/sim/core_ip_wraps_axi_intc_0_0.vhd"

vlog -work core_ip_wraps -vlog01compat $INCDIR \
"$PROJECT_SRC/sim/core_ip_wraps.v"

vlog -work blk_mem_gen_v8_4_4 -vlog01compat $INCDIR \
"$PROJECT_SRC/ipshared/2985/simulation/blk_mem_gen_v8_4.v"

vlog -work core_ip_wraps -vlog01compat $INCDIR \
"$PROJECT_SRC/ip/core_ip_wraps_blk_mem_gen_0_0/sim/core_ip_wraps_blk_mem_gen_0_0.v"

vcom -work axi_bram_ctrl_v4_1_2 -93 \
"$PROJECT_SRC/ipshared/a002/hdl/axi_bram_ctrl_v4_1_rfs.vhd"

vcom -work core_ip_wraps -93 \
"$PROJECT_SRC/ip/core_ip_wraps_axi_bram_ctrl_0_1/sim/core_ip_wraps_axi_bram_ctrl_0_1.vhd"

vcom -work lib_pkg_v1_0_2 -93 \
"$PROJECT_SRC/ipshared/0513/hdl/lib_pkg_v1_0_rfs.vhd"

vcom -work lib_srl_fifo_v1_0_2 -93 \
"$PROJECT_SRC/ipshared/51ce/hdl/lib_srl_fifo_v1_0_rfs.vhd"

vcom -work lib_fifo_v1_0_14 -93 \
"$PROJECT_SRC/ipshared/a5cb/hdl/lib_fifo_v1_0_rfs.vhd"

vcom -work lib_cdc_v1_0_2 -93 \
"$PROJECT_SRC/ipshared/ef1e/hdl/lib_cdc_v1_0_rfs.vhd"

vcom -work axi_datamover_v5_1_22 -93 \
"$PROJECT_SRC/ipshared/1e40/hdl/axi_datamover_v5_1_vh_rfs.vhd"

vcom -work axi_sg_v4_1_13 -93 \
"$PROJECT_SRC/ipshared/4919/hdl/axi_sg_v4_1_rfs.vhd"

vcom -work axi_cdma_v4_1_20 -93 \
"$PROJECT_SRC/ipshared/02b1/hdl/axi_cdma_v4_1_vh_rfs.vhd"

vcom -work core_ip_wraps -93 \
"$PROJECT_SRC/ip/core_ip_wraps_axi_cdma_0_0/sim/core_ip_wraps_axi_cdma_0_0.vhd"

vlog -work axi_clock_converter_v2_1_19 -vlog01compat $INCDIR \
"$PROJECT_SRC/ipshared/9e81/hdl/axi_clock_converter_v2_1_vl_rfs.v"

vlog -work core_ip_wraps -vlog01compat $INCDIR \
"$PROJECT_SRC/ip/core_ip_wraps_auto_cc_6/sim/core_ip_wraps_auto_cc_6.v"

vlog -work axi_protocol_converter_v2_1_20 -vlog01compat $INCDIR \
"$PROJECT_SRC/ipshared/c4a6/hdl/axi_protocol_converter_v2_1_vl_rfs.v"

vlog -work core_ip_wraps -vlog01compat $INCDIR \
"$PROJECT_SRC/ip/core_ip_wraps_auto_pc_4/sim/core_ip_wraps_auto_pc_4.v" \
"$PROJECT_SRC/ip/core_ip_wraps_auto_cc_7/sim/core_ip_wraps_auto_cc_7.v" \
"$PROJECT_SRC/ip/core_ip_wraps_auto_cc_8/sim/core_ip_wraps_auto_cc_8.v" \
"$PROJECT_SRC/ip/core_ip_wraps_auto_pc_5/sim/core_ip_wraps_auto_pc_5.v" \
"$PROJECT_SRC/ip/core_ip_wraps_auto_cc_9/sim/core_ip_wraps_auto_cc_9.v" \
"$PROJECT_SRC/ip/core_ip_wraps_auto_cc_10/sim/core_ip_wraps_auto_cc_10.v" \
"$PROJECT_SRC/ip/core_ip_wraps_auto_cc_0/sim/core_ip_wraps_auto_cc_0.v" \
"$PROJECT_SRC/ip/core_ip_wraps_auto_pc_0/sim/core_ip_wraps_auto_pc_0.v" \
"$PROJECT_SRC/ip/core_ip_wraps_auto_cc_1/sim/core_ip_wraps_auto_cc_1.v" \
"$PROJECT_SRC/ip/core_ip_wraps_auto_pc_1/sim/core_ip_wraps_auto_pc_1.v" \
"$PROJECT_SRC/ip/core_ip_wraps_auto_cc_2/sim/core_ip_wraps_auto_cc_2.v" \
"$PROJECT_SRC/ip/core_ip_wraps_auto_pc_2/sim/core_ip_wraps_auto_pc_2.v" \
"$PROJECT_SRC/ip/core_ip_wraps_auto_cc_3/sim/core_ip_wraps_auto_cc_3.v" \
"$PROJECT_SRC/ip/core_ip_wraps_auto_cc_4/sim/core_ip_wraps_auto_cc_4.v" \
"$PROJECT_SRC/ip/core_ip_wraps_auto_pc_3/sim/core_ip_wraps_auto_pc_3.v" \
"$PROJECT_SRC/ip/core_ip_wraps_auto_cc_5/sim/core_ip_wraps_auto_cc_5.v"

# --- Testbench / Reset Helper ---
vlog -work core_ip_wraps "D:/VLSI/7 Protocol/RISCV/subsystem_major_project/sim/glbl.v"
...
#vmap xil_defaultlib riviera/xil_defaultlib
#
#vlog -work xpm -sv "+incdir+/home/riscv/core_ip_wraps/rtl/core_ip_wraps.srcs/sources_1/bd/core_ip_wraps/ipshared/ec67/hdl" \
