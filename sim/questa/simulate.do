catch {file delete -force "sim_txt.log"}

echo "--- Starting UVM Simulation ---"

vsim -t 1ps -voptargs="+acc" -suppress 12110,3009 -sv_seed random \
-sv_lib "D:/Softwares/VLSI/QuestaSimSetup/uvm-1.2/win64/uvm_dpi" \
